...
A basic template of _Button Components_ using **React and Tailwind** developed by **G.Rubak preyan**
...
To clone this project in Local:

```bash
git clone "https://github.com/Rubakpreyan/Button-Component-React"
```

## Demo link

[Button Component](https://button-components-react-tailwind.netlify.app/)
